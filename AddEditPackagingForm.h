...
namespace CW {
    ...
    {
    public:
        property PackagingData^ ResultData;

        AddEditPackagingForm(PackagingData^ inputData)
        {
            InitializeComponent();
            ResultData = inputData;
            if (inputData != nullptr) {
                this->Text = "Редагувати тести: " + inputData->Id;
                ...
                txtPartsCount->Text = inputData->PackageType;
                txtAssemblyTime->Text = inputData->Materials;
                txtTool->Text = inputData->Design;
            }
            else {
                this->Text = "Додати новий тест";
...
#pragma region Windows Form Designer generated code
           void InitializeComponent(void)
           {
               ...
               this->lblPartsCount->Text = L"Тип упаковки:";
               ...
               this->lblAssemblyTime->Text = L"Матеріали:";
               ...
               this->btnOK->Click += gcnew System::EventHandler(this, &AddEditPackagingForm::btnOK_Click);
...
#pragma endregion
    ...
    private: System::Void btnOK_Click(System::Object^ sender, System::EventArgs^ e) {
        try {
            if (txtId->Text->Length == 0 || txtLocation->Text->Length == 0) {
                throw gcnew Exception("Поля ID та Місцезнаходження не можуть бути порожніми.");
            }
            ...
            if (ResultData == nullptr) {
                ResultData = gcnew PackagingData();
            }
            ...
            ResultData->PackageType = txtPartsCount->Text;
            ResultData->Materials = txtAssemblyTime->Text;
            ResultData->Design = txtTool->Text;
